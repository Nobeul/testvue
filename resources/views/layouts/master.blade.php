        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block" style="color:aliceblue; text-weight:bold">{{ Auth::user()->name}}</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <router-link :to="{path:'/users'}" href="#" class="nav-link">
                        ...
                        <li class="nav-item">
                            <router-link :to="{path:'/e'}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <i class="nav-icon fas fa-power-off text-blue"></i>
                                <p>
                                    {{ __('Logout') }}
                                </p>
                            </a>
